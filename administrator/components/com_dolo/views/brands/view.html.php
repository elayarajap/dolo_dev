 ...
 */
class DoloViewBrands extends JViewLegacy {
    ...
    protected function addToolbar() {
        ...
        JToolBarHelper::title(JText::_('COM_DOLO_TITLE_BRANDS'), 'brands.png');
        ...
        JHtmlSidebar::setAction('index.php?option=com_dolo&view=brands');
	...
	protected function getSortFields()
	{
		...
		'a.name' => JText::_('COM_DOLO_BRANDS_NAME'),
