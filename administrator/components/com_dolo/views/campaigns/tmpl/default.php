...
if ($saveOrder)
{
	$saveOrderingUrl = 'index.php?option=com_dolo&task=campaigns.saveOrderAjax&tmpl=component';
...
<?php endif;?>
		...
		<table class="table table-striped" id="campaignList">
			<thead>
				...
				<th class='left'>
				<?php echo JHtml::_('grid.sort',  'COM_DOLO_CAMPAIGNS_NAME', 'a.name', $listDirn, $listOrder); ?>
				</th>
				<th class='left'>
				<?php echo JHtml::_('grid.sort',  'COM_DOLO_CAMPAIGNS_START_DATE', 'a.start_date', $listDirn, $listOrder); ?>
				</th>
				<th class='left'>
				<?php echo JHtml::_('grid.sort',  'COM_DOLO_CAMPAIGNS_END_DATE', 'a.end_date', $listDirn, $listOrder); ?>
				</th>
				<th class='left'>
				<?php echo JHtml::_('grid.sort',  'COM_DOLO_CAMPAIGNS_BRANDID', 'a.brandid', $listDirn, $listOrder); ?>
				</th>
				<th class='left'>
				<?php echo JHtml::_('grid.sort',  'COM_DOLO_CAMPAIGNS_CAMPAIGNSTATUS_ID', 'a.campaignstatus_id', $listDirn, $listOrder); ?>
				</th>
			...
			<?php foreach ($this->items as $i => $item) :
				...
				<?php endif; ?>
				<?php if ($canEdit) : ?>
					<a href="<?php echo JRoute::_('index.php?option=com_dolo&task=campaign.edit&id='.(int) $item->id); ?>">
