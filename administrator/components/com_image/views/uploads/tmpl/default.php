...
$canOrder	= $user->authorise('core.edit.state', 'com_image');
$saveOrder	= $listOrder == 'a.ordering';
if ($saveOrder)
{
	$saveOrderingUrl = 'index.php?option=com_image&task=uploads.saveOrderAjax&tmpl=component';
	JHtml::_('sortablelist.sortable', 'uploadList', 'adminForm', strtolower($listDirn), $saveOrderingUrl);
}
...
<?php endif;?>
		...
		<table class="table table-striped" id="uploadList">
			...
			<?php foreach ($this->items as $i => $item) :
                ...
                <?php if (isset($this->items[0]->state)): ?>
					<td class="center">
						<?php echo JHtml::_('jgrid.published', $item->state, $i, 'uploads.', $canChange, 'cb'); ?>
					</td>
                <?php endif; ?>
