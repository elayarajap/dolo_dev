...
/**
 * View class for a list of Image.
 */
class ImageViewUploads extends JViewLegacy {
    ...
    public function display($tpl = null) {
        ...
        ImageHelper::addSubmenu('uploads');
    ...
    protected function addToolbar() {
        ...
        $canDo = ImageHelper::getActions($state->get('filter.category_id'));

        JToolBarHelper::title(JText::_('COM_IMAGE_TITLE_UPLOADS'), 'uploads.png');
        ...
        if ($canDo->get('core.admin')) {
            JToolBarHelper::preferences('com_image');
        }

        //Set sidebar action - New in 3.0
        JHtmlSidebar::setAction('index.php?option=com_image&view=uploads');
	...
	protected function getSortFields()
	{
		...
		'a.image' => JText::_('COM_IMAGE_UPLOADS_IMAGE'),
		);
	}
