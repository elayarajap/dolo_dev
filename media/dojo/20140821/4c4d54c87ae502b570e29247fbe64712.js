...
dojo.addOnLoad(function(){
      ...
      new OfflajnText({
        ...
        new OfflajnImagemanager({
          ...
          description: "",
          siteurl: "http://dolo.insessus.com/"
        });
    ...
    dojo.connect(el, "change", function(){
      ...
      new OfflajnCombine({
        ...
        new FontConfigurator({
          ...
          defaultTab: "Text",
          origsettings: {"Text":{"lineheight":"normal","type":"0","family":"","subset":"","size":"12||px","color":"ffffff","tshadow":"1||px|*|1||px|*|0|*|000000b3|*|1","afont":"Helvetica||1","bold":"0"}},
...
jQuery.fn.jPicker.defaults.images.clientPath="http://dolo.insessus.com/administrator/../modules/mod_improved_ajax_login/params/offlajncolor/offlajncolor/jpicker/images/";
    ...
    dojo.connect(el, "change", function(){
      ...
      new OfflajnCombine({
        ...
        new FontConfigurator({
          ...
          defaultTab: "Text",
          origsettings: {"Text":{"lineheight":"normal","type":"0","subset":"","family":"","size":"12||px","color":"5d5c5c","afont":"Helvetica||1","underline":"0","bold":"0","tshadow":"0|*|0|*|0|*|000000b3|*|0"},"Link":{"color":"1685d7","underline":"0"},"Hover":{"color":"1186bb","underline":"0"}},
