...
$font = '#'.htmlspecialchars($_GET['font']);
$skinColor = '#'.htmlspecialchars($_GET['skinColor']);
...
$overrideColorRGBA = 'rgba('.implode(",", hex2rgb($overrideColor)).', 0.8)';
?>
